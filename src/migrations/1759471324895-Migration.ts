...
export class Migration1759471324895 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."leave_approvals_approvertype_enum" AS ENUM('reporting_manager', 'hr_manager')`);
        await queryRunner.query(`CREATE TYPE "public"."leave_approvals_action_enum" AS ENUM('approve', 'reject')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."leave_workflows_currentstage_enum" AS ENUM('pending_rm', 'pending_hr', 'completed')`);
        await queryRunner.query(`CREATE TABLE "leave_workflows" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "leaveRequestId" uuid NOT NULL, "reportingManagerApproval" boolean NOT NULL DEFAULT false, "hrManagerApproval" boolean NOT NULL DEFAULT false, "currentStage" "public"."leave_workflows_currentstage_enum" NOT NULL DEFAULT 'pending_rm', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_e292243d8cd6c9fd3936e8850d" UNIQUE ("leaveRequestId"), CONSTRAINT "PK_568e285f3dc48d8653ef8ead05b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."leave_requests_leavetype_enum" AS ENUM('casual', 'sick', 'vacation', 'maternity')`);
        await queryRunner.query(`CREATE TYPE "public"."leave_requests_status_enum" AS ENUM('pending', 'pending_hr', 'approved', 'rejected')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."employees_role_enum" AS ENUM('employee', 'reporting_manager', 'hr_manager', 'admin')`);
        ...
        await queryRunner.query(`ALTER TABLE "leave_approvals" ADD CONSTRAINT "FK_f9d987693b8da6a02b566158512" FOREIGN KEY ("leaveRequestId") REFERENCES "leave_requests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "leave_approvals" ADD CONSTRAINT "FK_ffa85f79b5fde37f5336d39e240" FOREIGN KEY ("approverId") REFERENCES "employees"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "leave_workflows" ADD CONSTRAINT "FK_e292243d8cd6c9fd3936e8850da" FOREIGN KEY ("leaveRequestId") REFERENCES "leave_requests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "employees" ADD CONSTRAINT "FK_12c6c1ac43cccd5c7b71fe5e53a" FOREIGN KEY ("reportingManagerId") REFERENCES "employees"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "leave_workflows" DROP CONSTRAINT "FK_e292243d8cd6c9fd3936e8850da"`);
        await queryRunner.query(`ALTER TABLE "leave_approvals" DROP CONSTRAINT "FK_ffa85f79b5fde37f5336d39e240"`);
        await queryRunner.query(`ALTER TABLE "leave_approvals" DROP CONSTRAINT "FK_f9d987693b8da6a02b566158512"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."leave_workflows_currentstage_enum"`);
        await queryRunner.query(`DROP TABLE "leave_approvals"`);
        await queryRunner.query(`DROP TYPE "public"."leave_approvals_action_enum"`);
        await queryRunner.query(`DROP TYPE "public"."leave_approvals_approvertype_enum"`);
    }
